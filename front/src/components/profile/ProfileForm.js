  ...
  return (
    <div className="pt-[12vh] px-4 pb-[10vh] flex flex-col items-center">
      ...
      <div className="bg-white w-full max-w-lg rounded-2xl shadow-lg p-6 text-center">
        ...
        {/* 닉네임 */}
        <h2 className="text-[2.6vh] font-bold text-gray-800 tracking-tight mb-1">{userData.userName}</h2>
        ...
        {/* 전화번호 */}
        <div className="bg-gray-100 px-4 py-2 rounded-lg text-left mb-4 text-base text-gray-600">{userData.tel}</div>
