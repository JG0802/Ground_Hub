...
// public DataInitializer(UserRepository userRepository, TeamRepository
// teamRepository, GameRepository matchRepository) {
...
// userRepository.findUserByUserMail(user.getUserMail());
...
// teamRepository.findTeamByTeamId(team.getTeamId());
...
// matchRepository.findGameByGameId(game.getGameId());
